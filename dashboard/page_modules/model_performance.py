...
def show():
    ...
    for col, model, metric, label, color in zip(cols, models, metrics, labels, colors):
        with col:
            st.markdown(
    ...
    with col7:
        ...
        fig_auc.update_layout(yaxis_range=[0, 1], title="ROC-AUC by Model")
    ...
    with col8:
        ...
        fig_metrics.update_layout(yaxis_range=[0, 1], title="XGBoost Banking Metrics")
